...
//------------------------------------------------------------------------------
   ...
   localparam NUM_MASTER  = 2 
            , NUM_SLAVE   = 5;
   localparam AXI_ADDR_BASE0  =P_ADDR_START_MEM
            , AXI_ADDR_LENGTH0=P_ADDR_LENGTH_MEM
            , AXI_ADDR_BASE1  =P_ADDR_START_MEM_TX
            , AXI_ADDR_LENGTH1=P_ADDR_LENGTH_MEM_TX
            , AXI_ADDR_BASE2  =P_ADDR_START_MEM_RX
            , AXI_ADDR_LENGTH2=P_ADDR_LENGTH_MEM_RX
            , AXI_ADDR_BASE3  =P_ADDR_START_GMAC
            , AXI_ADDR_LENGTH3=P_ADDR_LENGTH_GMAC
            , AXI_ADDR_BASE4  =P_ADDR_START_APB
            , AXI_ADDR_LENGTH4=P_ADDR_LENGTH_APB;
   //---------------------------------------------------------------------------
   `ifdef SIM
   `define BUS_DELAY  #(1)
   `else
   ...
   axi_switch_m2s5
       #(.WIDTH_CID   (AXI_WIDTH_CID   )
        ...
        ,.ADDR_BASE3  (AXI_ADDR_BASE3  )
        ,.ADDR_LENGTH3(AXI_ADDR_LENGTH3)
        ,.ADDR_BASE4  (AXI_ADDR_BASE4  )
        ,.ADDR_LENGTH4(AXI_ADDR_LENGTH4)
        )
   u_axi_switch_m2s4 (
          .ARESETn              (ARESETn      )
        , .ACLK                 (ACLK         )
        ...
        , .S3_AWLEN             (S_AWLEN   [3])
        , .S3_AWLOCK            (S_AWLOCK  [3])
        , .S3_AWSIZE            (S_AWSIZE  [3])
        , .S3_AWBURST           (S_AWBURST [3])
        `ifdef AMBA_AXI_CACHE
        , .S3_AWCACHE           (S_AWCACHE [3])
        `endif
        `ifdef AMBA_AXI_PROT
        , .S3_AWPROT            (S_AWPROT  [3])
        `endif
        , .S3_AWVALID           (S_AWVALID [3])
        , .S3_AWREADY           (S_AWREADY [3])
        `ifdef AMBA_AXI4
        , .S3_AWQOS             (S_AWQOS   [3])
        , .S3_AWREGION          (S_AWREGION[3])
        `endif
        `ifdef AMBA_AXI_AWUSER
        , .S3_AWUSER            (S_AWUSER  [3])
        `endif
        , .S3_WID               (S_WID     [3])
        , .S3_WDATA             (S_WDATA   [3])
        , .S3_WSTRB             (S_WSTRB   [3])
        ...
        , .S3_ARLEN             (S_ARLEN   [3])
        , .S3_ARLOCK            (S_ARLOCK  [3])
        , .S3_ARSIZE            (S_ARSIZE  [3])
        , .S3_ARBURST           (S_ARBURST [3])
        `ifdef AMBA_AXI_CACHE
        , .S3_ARCACHE           (S_ARCACHE [3])
        `endif
        `ifdef AMBA_AXI_PROT
        , .S3_ARPROT            (S_ARPROT  [3])
        `endif
        , .S3_ARVALID           (S_ARVALID [3])
        , .S3_ARREADY           (S_ARREADY [3])
        `ifdef AMBA_AXI4
        , .S3_ARQOS             (S_ARQOS   [3])
        , .S3_ARREGION          (S_ARREGION[3])
        `endif
        `ifdef AMBA_AXI_ARUSER
        , .S3_ARUSER            (S_ARUSER  [3])
        `endif
        , .S3_RID               (S_RID     [3])
        , .S3_RDATA             (S_RDATA   [3])
        , .S3_RRESP             (S_RRESP   [3])
        ...
        `endif
        , .S4_AWID              (S_AWID    [4])
        , .S4_AWADDR            (S_AWADDR  [4])
        , .S4_AWLEN             (S_AWLEN   [4])
        , .S4_AWLOCK            (S_AWLOCK  [4])
        , .S4_AWSIZE            (S_AWSIZE  [4])
        , .S4_AWBURST           (S_AWBURST [4])
        `ifdef AMBA_AXI_CACHE
        , .S4_AWCACHE           (S_AWCACHE [4])
        `endif
        `ifdef AMBA_AXI_PROT
        , .S4_AWPROT            (S_AWPROT  [4])
        `endif
        , .S4_AWVALID           (S_AWVALID [4])
        , .S4_AWREADY           (S_AWREADY [4])
        `ifdef AMBA_AXI4
        , .S4_AWQOS             (S_AWQOS   [4])
        , .S4_AWREGION          (S_AWREGION[4])
        `endif
        `ifdef AMBA_AXI_AWUSER
        , .S4_AWUSER            (S_AWUSER  [4])
        `endif
        , .S4_WID               (S_WID     [4])
        , .S4_WDATA             (S_WDATA   [4])
        , .S4_WSTRB             (S_WSTRB   [4])
        ...
        `endif
        , .S4_ARID              (S_ARID    [4])
        , .S4_ARADDR            (S_ARADDR  [4])
        , .S4_ARLEN             (S_ARLEN   [4])
        , .S4_ARLOCK            (S_ARLOCK  [4])
        , .S4_ARSIZE            (S_ARSIZE  [4])
        , .S4_ARBURST           (S_ARBURST [4])
        `ifdef AMBA_AXI_CACHE
        , .S4_ARCACHE           (S_ARCACHE [4])
        `endif
        `ifdef AMBA_AXI_PROT
        , .S4_ARPROT            (S_ARPROT  [4])
        `endif
        , .S4_ARVALID           (S_ARVALID [4])
        , .S4_ARREADY           (S_ARREADY [4])
        `ifdef AMBA_AXI4
        , .S4_ARQOS             (S_ARQOS   [4])
        , .S4_ARREGION          (S_ARREGION[4])
        `endif
        `ifdef AMBA_AXI_ARUSER
        , .S4_ARUSER            (S_ARUSER  [4])
        `endif
        , .S4_RID               (S_RID     [4])
        , .S4_RDATA             (S_RDATA   [4])
        , .S4_RRESP             (S_RRESP   [4])
