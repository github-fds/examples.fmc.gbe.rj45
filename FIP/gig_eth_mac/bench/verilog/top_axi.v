...
//------------------------------------------------------------------------------
   ...
   localparam NUM_MASTER  = 2 
            , NUM_SLAVE   = 3;
   localparam AXI_WIDTH_CID   = 2    // Channel ID width in bits
   ...
   localparam AXI_ADDR_BASE0  =`ADDR_START_MEM_TX
            , AXI_ADDR_LENGTH0=`ADDR_LENGTH
            , AXI_ADDR_BASE1  =`ADDR_START_MEM_RX
            , AXI_ADDR_LENGTH1=`ADDR_LENGTH
            , AXI_ADDR_BASE2  =`ADDR_START_GMAC
            , AXI_ADDR_LENGTH2=10;
   localparam BUS_DELAY=1;
   //---------------------------------------------------------------------------
   wire  ARESETn;
   wire  ACLK   ;
   //---------------------------------------------------------------------------
