...
(
     ...
     localparam STW_IDLE   = 'h0,
                ...
                STW_WRITE  = 'h2,
                STW_RSP    = 'h3;
     reg [1:0] stateW=STW_IDLE; // synthesis attribute keep of stateW is "true";
     ...
     localparam STR_IDLE   = 'h0,
                ...
                STR_READ34 = 'hA,
                STR_END    = 'hB;
     reg [3:0] stateR=STR_IDLE; // synthesis attribute keep of stateR is "true";
     always @ (posedge ACLK or negedge ARESETn) begin
     if (ARESETn==1'b0) begin
         ARADDR_reg  <= 'h0;
         ARLEN_reg   <= 'h0;
 ...
 //end else if (P_SIZE_IN_BYTES==8*1024) begin : BLK_8KB
