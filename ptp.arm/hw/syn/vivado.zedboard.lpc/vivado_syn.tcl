...
# Assemble the design source files
     ...
     set DIR_PTP             "${DIR_FIP}/gig_eth_ptpv2_lite"
     ...
     set DIR_TIMER           "${DIR_FIP}/timer_amba"
     ...
     set DIR_PTP_AFIFO          "${DIR_PTP}/fifo_async/z7/${VIVADO_VER}"

     read_edif "
         ${DIR_GBE_AXI}/syn/vivado.${FPGA_TYPE}/gig_eth_mac_ptp_axi.edif
         ${DIR_PTP}/syn/vivado.${FPGA_TYPE}/gig_eth_ptpv2_lite_apb.edif
     ...
     read_verilog  "
                ./syn_define.v
                ${DIR_RTL}/mac_ptp_axi.v
                ${DIR_MEM_AXI}/rtl/verilog/bram_axi.v
                ${DIR_MEM_AXI_DUAL}/rtl/verilog/bram_axi_dual.v
                ${DIR_GBE_AXI}/rtl/verilog/gig_eth_mac_ptp_axi_stub.v
                ${DIR_PTP}/rtl/verilog/gig_eth_ptpv2_lite_apb_stub.v
                ${DIR_MDIO_AXI}/rtl/verilog/mdio_apb_stub.v
                ${DIR_AMBA_AXI}/rtl/verilog/axi_switch_m2s5.v
                ${DIR_AMBA_APB}/rtl/verilog/axi_to_apb_s5.v
                ${DIR_GPIO}/rtl/verilog/gpio_apb.v
                ${DIR_TIMER}/rtl/verilog/timer_apb.v
     "
     ...
     set XDC_LIST "
         ...
         ${DIR_XDC}/fmc-gbe-rj45-p0_lpc_zed.xdc
         ${DIR_XDC}/mac_ptp_axi.xdc
         ${DIR_XDC}/fpga_zed_ptp.xdc
     "
