...
#--------------------------------------------------------
# Push Button
#set_property PACKAGE_PIN P16 [get_ports BOARD_BTNC] ==> BOARD_RST_SW
set_property PACKAGE_PIN R16 [get_ports BOARD_BTND]
#set_property PACKAGE_PIN N15 [get_ports BOARD_BTNL]
#set_property PACKAGE_PIN R18 [get_ports BOARD_BTNR]
set_property PACKAGE_PIN T18 [get_ports BOARD_BTNU]
set_property IOSTANDARD LVCMOS25 [get_ports BOARD_BTN*]
set_input_delay -clock [get_clocks BOARD_CLK_IN] 10.000 [get_ports BOARD_BTN*]
set_false_path -from [get_ports BOARD_BTN*]
